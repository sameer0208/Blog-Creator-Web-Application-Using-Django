...
if os.path.isdir('/opt/app-root/secrets/database'):
    def database_url(urlparse=None):
        try:
...
BLOG_SITE_NAME = 'JSMP Blog Application'
...
BLOG_BANNER_IMAGE = 'static/banner.png';
BLOG_BANNER_IMAGE = BLOG_SETTINGS.get('BLOG_BANNER_IMAGE', BLOG_BANNER_IMAGE)
BLOG_BANNER_IMAGE = os.environ.get('BLOG_BANNER_IMAGE', BLOG_BANNER_IMAGE)
KUBE_POD_NAME = 'Create Your Blog with JSMP'
